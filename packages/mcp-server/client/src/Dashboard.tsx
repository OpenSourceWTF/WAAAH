...
interface Agent {
  ...
  lastSeen?: number;
  currentTasks?: string[];
  // Extended metadata for expandable cards
  capabilities?: string[];
  createdAt?: number;
  color?: string;
}
...
export function Dashboard() {
  ...
  // Agent Card State: pinned (clicked) and hovered (temporary expand)
  ...
  // Get relative time display (e.g., "2m ago", "1h ago")
  ...
  // Toggle Agent Expansion (pinned state)
